      ...
      <div class="column is-8">
        <section class="section is-size-5">
          ...
          <p><em>Please remember, we offer a range of stylists to suit different budgets, so there are options for
            everyone!</em></p>
          <p class="is-size-4">Your continued support means the world to us and keeps our salon running – thank you, sincerely. If you have any questions or concerns, don’t hesitate to get in touch.</p>
        </section>
      </div>
    </div>
  </div>
