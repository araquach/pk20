    ...
    <div class="columns">
      <div class="column is-8">
        <div class="top section">
          ...
          <h2 class="title is-4 is-size-6-mobile has-text-primary">Full colour, cut & blowdry for £100 with Eve or Lauren</h2>
    ...
    <div class="columns">
      <div class="column is-8">
        <div class="section">
          ...
          <p class="is-size-5"><em>An ideal first appointment if you’re looking for professional, polished results deliver by experienced stylists.</em></p>
