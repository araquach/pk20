<template>
  <div id="ind-offer">
    <div class="columns">
      <div class="column is-8">
        <div class="top section">
          <h2 class="title is-2 is-size-4-mobile has-text-primary">Special offer with David & Lauren</h2>
          <p class="is-size-5">These two amazing stylists consistently produce outstanding looks</p>
          <p class="is-size-4"><strong>If you're considering a new stylist then take advantage of this great offer with either of them&hellip;</strong></p>
        </div>
      </div>
    </div>
    <figure class="image">
    ...
    <div class="columns">
      <div class="column is-8">
        <div class="section">
          <p class="is-size-5"><strong>Come in for a FREE consultation with one of them and if you like the ideas they come up with then book in to get 25% off your visit!</strong></p>
