    ...
    <div class="columns">
      <div class="column is-8">
        <div class="top section">
          ...
          <p class="is-size-4">£20 off all hair cuts when you book in for a colour this January and February.</p>
          <p class="is-size-5"><strong>Get new hair and money off at Paul Kemp Hairdressing.</strong></p>
        </div>
      </div>
    </div>
