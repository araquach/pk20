<template>
  <div id="ind-offer">
    ...
    <figure class="image">
      <img src="/dist/img/offer/abi_montage.png" alt="Abi Clarke Offers">
    </figure>
    <div class="columns">
      <div class="column is-8">
        <div class="section">
          ...
          <router-link :to="{ name: 'team-detail', params: { slug: 'abi' } }" class="button is-primary">Find out more about Abi</router-link>
          <br><br>
          <div id="fb-like">
            <div class="fb-like" data-href="https://www.paulkemphairdressing.com/offers/abi" data-width="250" data-layout="standard" data-action="like" data-size="large" data-show-faces="false" data-share="true"></div>
          </div>
        </div>
      </div>
    </div>
