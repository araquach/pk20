    ...
    <div class="section tile is-ancestor is-size-5-mobile">
      <div class="tile is-parent is-5">
        <div class="tile is-child">
          ...
          <router-link :to="{ name: 'contact' }">Map and more info here</router-link>
        </div>
      </div>
      <div class="tile is-parent is-vertical">
        <div class="tile is-child">
          <figure class="image is-240x160">
            <img src="/dist/img/salon/salon_shot_new_1.jpg" alt="The Sloane Salon">
          </figure>
        </div>
        <div class="tile is-child">
          <figure class="image is-240x160">
            <img src="/dist/img/salon/salon_shot_new_2.jpg" alt="The Sloane Salon">
          </figure>
        </div>
        <div class="tile is-child">
          <figure class="image is-240x160">
            <img src="/dist/img/salon/salon_shot_new_3.jpg" alt="The Sloane Salon">
          </figure>
        </div>
      </div>
      <div class="tile is-parent is-vertical">
        <div class="tile is-child">
          <figure class="image is-240x160">
            <img src="/dist/img/salon/salon_shot_new_4.jpg" alt="The Sloane Salon">
          </figure>
        </div>
        <div class="tile is-child">
          <figure class="image is-240x160">
            <img src="/dist/img/salon/salon_shot_new_5.jpg" alt="The Sloane Salon">
          </figure>
        </div>
        <div class="tile is-child">
          <figure class="image is-240x160">
            <img src="/dist/img/salon/salon_shot_new_6.jpg" alt="The Sloane Salon">
          </figure>
        </div>
      </div>
    </div>
