      ...
      <div class="column is-6">
        <section class="section has-text-white">
          <h1 class="title is-2 has-text-white">Join the Team</h1>
            ...
            <router-link :to="{ name: 'recruitment-stylist' }" class="button is-primary">Apply for for a Stylist position</router-link>
            <br><br>
            ...
            <p><em><strong class="has-text-white">If you have the passion to do whatever it takes to be a top stylist then apply now!</strong></em></p>
            <router-link :to="{ name: 'recruitment-apprentice' }" class="button is-primary">Apply for for an Apprentice position</router-link>
            <br><br>
