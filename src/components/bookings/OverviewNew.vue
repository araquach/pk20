<template>
  <div>
    <div v-if="!view">
      ...
      <p class="is-size-4">Thanks for choosing to book an appointment at Sloane The Salon. We know you'll love what we have to offer and can't wait to introduce you to the team!</p>
