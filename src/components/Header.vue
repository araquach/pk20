      ...
      <b-navbar class="is-transparent">
        <template slot="brand">
          <b-navbar-item tag="router-link" :to="{ path: '/' }">
            <img src="/dist/img/header/sloane_logo_light.svg" width="200" class="mr-5">
          </b-navbar-item>
        </template>
        <template slot="start">
...
<!--          </b-navbar-item>-->
          ...
          <b-navbar-item tag="router-link" :to="{ name: 'refer' }">
            Referrals
          </b-navbar-item>
...
<!--            </b-navbar-item>-->
            ...
            <b-navbar-item tag="router-link" :to="{ name: 'recruitment' }">
              Recruitment
            </b-navbar-item>
          </b-navbar-dropdown>
        </template>
